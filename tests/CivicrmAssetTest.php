 ...
 * Additionally, we assert that Civi's asset plugin performs publication after
 * compilation
 */
class CivicrmAssetTest extends ScssPhpMethodTest
{
    ...
    {
        $this->assertFileNotExists('web/civi/org.example.gnocchi/build.css');
        parent::testComposerInstall();
        $this->assertSameCssFile('vendor/test/gnocchi/build.css-expected', 'web/civi/org.example.gnocchi/build.css');
    }
}
